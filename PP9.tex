...
\begin{Figure}
	...
	\captionof{figure}{Distribuzione media delle armoniche di cinque campioni di rumore, è evidente l'effetto del filtro sulle componenti}
...
\begin{Figure}
	\begin{center}
	\includegraphics[width=0.8\linewidth]{impulsoOsc}
	\captionof{figure}{Istantanea dell'oscilloscopio dell'onda quadra prodotta da Arduino per ottenere un segnale impulsivo}
...
\begin{Figure}
	\begin{center}
	\includegraphics[width=\linewidth]{impulso}
